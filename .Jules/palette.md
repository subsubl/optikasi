...
## 2026-10-29 - Required Field Indicators and Hidden Symbols
**Learning:** Adding visual asterisks (*) to denote required fields can cause screen readers to announce "asterisk", which is annoying when the field already has a `required` attribute.
