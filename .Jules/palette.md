...
## 2026-10-29 - Social Media Icon Focus Readability
**Learning:** Focus rings on elements placed over dark backgrounds (e.g. global footers) can be nearly invisible if they lack proper offset and contrast colors.
**Action:** When applying keyboard focus indicators on dark backgrounds, use `focus-visible:ring-offset-2` alongside `focus-visible:ring-offset-[dark-color]` to ensure the focus ring maintains high contrast and clear visibility.
