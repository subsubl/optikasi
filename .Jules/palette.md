...
**Action:** Ensure the target container of a skip link always includes `id="target-id"`, `tabindex="-1"`, and `focus:outline-none` (using Tailwind, or standard CSS) to smoothly accept and manage programmatic focus without visual disruption.\n## 2026-05-13 - Focus Ring Visibility on Dark Backgrounds\n**Learning:** Standard focus rings (`focus-visible:ring-2`) often disappear or lack sufficient contrast when placed on very dark backgrounds like the footer.\n**Action:** When applying focus styles to elements on dark backgrounds, automatically include `focus-visible:ring-offset-2 focus-visible:ring-offset-primary-dark` (or equivalent background color) to ensure the focus indicator is clearly visible to keyboard users.
