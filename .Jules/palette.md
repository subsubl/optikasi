...
## 2026-05-10 - Accessible Star Ratings
**Learning:** Repeating visual elements like '★' in a 5-star rating are read redundantly by screen readers (e.g., 'star star star star star').
**Action:** Group these elements in a container with `role="img"` and a localized `aria-label` (e.g., '5 od 5 zvezdic'), and apply `aria-hidden="true"` to the decorative child stars.
