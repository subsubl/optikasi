  ...
  <section class="py-24 bg-white">
    <div class="container mx-auto px-6">
      ...
      <div class="relative group/scrollnav">
        ...
        <button
          @click="scroll('left')"
          aria-controls="new-arrivals-scroll"
        ...
        <div
          ...
          tabindex="0"
          role="region"
          aria-label="Najnovejši okvirji - drsnik"
          class="flex overflow-x-auto gap-8 pb-4 -mx-6 px-6 snap-x snap-mandatory scrollbar-hide scroll-smooth focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset"
        >
          <div
