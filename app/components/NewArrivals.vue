    ...
    <div class="container mx-auto px-6">
      ...
      <div class="relative group/scrollnav">
        ...
        <div
          ...
          tabindex="0"
          role="region"
          aria-label="Najnovejši okvirji"
          class="flex overflow-x-auto gap-8 pb-4 -mx-6 px-6 snap-x snap-mandatory scrollbar-hide scroll-smooth focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-inset"
        >
          <div
