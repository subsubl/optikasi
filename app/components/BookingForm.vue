<template>
  <form @submit.prevent="submitForm" class="space-y-6 bg-white p-8 border border-gray-100 shadow-sm">
    ...
    <div class="grid md:grid-cols-2 gap-6">
      <div class="space-y-2">
        <label for="name" class="text-xs uppercase tracking-widest text-gray-500 font-bold">Ime in Priimek<span aria-hidden="true" class="text-red-500 ml-1">*</span></label>
      ...
      <div class="space-y-2">
        <label for="email" class="text-xs uppercase tracking-widest text-gray-500 font-bold">Email Naslov<span aria-hidden="true" class="text-red-500 ml-1">*</span></label>
