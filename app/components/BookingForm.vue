<template>
  <form @submit.prevent="submitForm" class="space-y-6 bg-white p-8 border border-gray-100 shadow-sm">
    ...
    <fieldset class="border-none p-0 m-0 space-y-4 pt-4">
      <legend class="w-full block text-xs uppercase tracking-widest text-gray-500 font-bold mb-2">Želeni Termini (Izberite več možnosti)</legend>

      <!-- Weekdays -->
      <fieldset class="border-none p-0 m-0">
        <legend class="sr-only">Izberite želene dneve</legend>
      ...
      <!-- Time Slots -->
      <fieldset class="border-none p-0 m-0">
        <legend class="sr-only">Izberite želene termine</legend>
