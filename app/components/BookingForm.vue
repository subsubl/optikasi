<template>
  <form @submit.prevent="submitForm" class="space-y-6 bg-white p-8 border border-gray-100 shadow-sm">
    ...
    <fieldset class="space-y-4 pt-4 border-none p-0 m-0">
      <legend class="text-xs uppercase tracking-widest text-gray-500 font-bold block w-full mb-2">Želeni Termini (Izberite več možnosti)</legend>
      ...
      <!-- Time Slots -->
      <fieldset class="border-none p-0 m-0">
        <legend class="sr-only">Deli dneva</legend>
