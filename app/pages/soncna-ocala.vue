<template>
  <div>
    ...
    <section class="relative h-[60vh] min-h-[500px] flex items-center justify-center bg-gray-900 text-white overflow-hidden">
      ...
      <div class="relative z-10 text-center px-6 max-w-4xl">
        ...
        <p class="text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto">
          Dizajnerska in korekcijska sončna očala za popolno zaščito pred soncem.
        </p>
      </div>
    </section>
    ...
    <section class="py-24 bg-cream">
      <div class="container mx-auto px-6 max-w-4xl">
        <div class="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 class="text-3xl font-serif text-primary-dark mb-6">Zakaj Kvalitetna Sončna Očala?</h2>
            <p class="text-gray-600 leading-relaxed mb-6">
              Sončna očala niso le modni dodatek — so ključna zaščita za vaše oči pred škodljivimi 
              UV žarki in bleščanjem. Naša sončna očala združujejo natančno korekcijo vida z 
          ...
          <div class="bg-white p-8 shadow-sm border border-gray-100 text-center">
            ...
            <h3 class="font-serif text-xl text-primary-dark mb-3">Tudi z Dioptrijo</h3>
            <p class="text-gray-600 text-sm">
              Vsa naša sončna očala so na voljo tudi s korekcijskimi stekli po vaši meri.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container mx-auto px-6 max-w-5xl">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="text-center p-8 border border-gray-100 hover:border-accent transition-colors">
            ...
            <h3 class="font-serif text-xl text-primary-dark mb-3">Klasična Sončna</h3>
          ...
          <div class="text-center p-8 border border-gray-100 hover:border-accent transition-colors">
            <span class="text-4xl block mb-4">⛷️</span>
            <h3 class="font-serif text-xl text-primary-dark mb-3">Športna Sončna</h3>
            <p class="text-gray-600 text-sm leading-relaxed">
              Za kolesarjenje, tek, golf ali smučanje. Lahka, vzdržljiva in z 
              optimalnim pokritjem.
            </p>
          </div>

          <div class="text-center p-8 border border-gray-100 hover:border-accent transition-colors">
            <span class="text-4xl block mb-4">💎</span>
            <h3 class="font-serif text-xl text-primary-dark mb-3">Dizajnerska Sončna</h3>
            <p class="text-gray-600 text-sm leading-relaxed">
    ...
    <section class="py-24 bg-cream">
      <div class="container mx-auto px-6 max-w-4xl">
        <h2 class="text-3xl font-serif text-primary-dark mb-12 text-center">Možnosti Stekel</h2>
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <div class="bg-white p-8 border border-gray-100">
            <h3 class="font-serif text-xl text-primary-dark mb-4">Zrcalna Stekla</h3>
            <p class="text-gray-600 text-sm leading-relaxed">
    ...
    <section class="py-20 bg-primary-dark text-center">
      <div class="container mx-auto px-6 max-w-3xl">
        <h2 class="text-3xl font-serif text-white mb-6">Poiščite Popolna Sončna Očala</h2>
        <p class="text-gray-300 mb-8">
          Obiščite nas in izbirajte izmed vrhunskih znamk. Na voljo tudi z dioptrijo.
        </p>
        <NuxtLink 
          to="/kontakt" 
...
<script setup>
useHead({
  title: 'Sončna Očala - Zaščita in Stil',
  meta: [
    { name: 'description', content: 'Dizajnerska in korekcijska sončna očala v Ljubljani. Ray-Ban, Gucci, Oakley. Polarizirajoča, fotokromna in zrcalna stekla. Tudi z dioptrijo.' },
    { name: 'keywords', content: 'sončna očala ljubljana, polarizirajoča očala, ray-ban, gucci sončna očala, sončna očala z dioptrijo' }
  ]
})
</script>
