  ...
  <div class="py-24 container mx-auto px-6 max-w-3xl">
    ...
    <form @submit.prevent="submitOrder" class="bg-white p-8 md:p-12 shadow-sm border border-gray-100 space-y-8">
      ...
      <div>
        ...
        <div class="grid md:grid-cols-2 gap-6">
          <div class="flex flex-col">
            <label for="name" class="text-xs uppercase tracking-widest text-gray-500 mb-2">Ime in Priimek <span class="text-accent" aria-hidden="true">*</span></label>
          ...
          <div class="flex flex-col">
            <label for="email" class="text-xs uppercase tracking-widest text-gray-500 mb-2">E-naslov <span class="text-accent" aria-hidden="true">*</span></label>
      ...
      <div>
        ...
        <div class="space-y-6">
          <div class="flex flex-col">
            <label for="brand" class="text-xs uppercase tracking-widest text-gray-500 mb-2">Znamka Kontaktnih Leč (npr. Acuvue, Air Optix, Biofinity) <span class="text-accent" aria-hidden="true">*</span></label>
