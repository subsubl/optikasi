  ...
  <div class="py-24 container mx-auto px-6 max-w-3xl">
    ...
    <form @submit.prevent="submitOrder" class="bg-white p-8 md:p-12 shadow-sm border border-gray-100 space-y-8">
      ...
      <fieldset class="border-none p-0 m-0">
        <legend class="w-full text-lg font-serif text-primary-dark border-b border-gray-100 pb-2 mb-6 block">Osebni Podatki</legend>
      ...
      <!-- Lens Details -->
      <fieldset class="border-none p-0 m-0">
        <legend class="w-full text-lg font-serif text-primary-dark border-b border-gray-100 pb-2 mb-6 block">Podatki o Lečah</legend>
        <div class="space-y-6">
          <div class="flex flex-col">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <!-- Left Eye -->
            <fieldset class="bg-gray-50 p-4 rounded-sm border-none m-0">
              <legend class="w-full block text-center font-bold text-primary-dark mb-4">Levo Oko (OS)</legend>
              <div class="space-y-3">
            ...
            <!-- Right Eye -->
            <fieldset class="bg-gray-50 p-4 rounded-sm border-none m-0">
              <legend class="w-full block text-center font-bold text-primary-dark mb-4">Desno Oko (OD)</legend>
              <div class="space-y-3">
