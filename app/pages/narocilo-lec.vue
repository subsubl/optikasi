        ...
        <div class="space-y-6">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            <fieldset class="bg-gray-50 p-4 rounded-sm border-none m-0">
              <legend class="w-full text-center font-bold text-primary-dark mb-4 block">Levo Oko (OS)</legend>
              <div class="space-y-3">
            ...
            <!-- Right Eye -->
            <fieldset class="bg-gray-50 p-4 rounded-sm border-none m-0">
              <legend class="w-full text-center font-bold text-primary-dark mb-4 block">Desno Oko (OD)</legend>
              <div class="space-y-3">
