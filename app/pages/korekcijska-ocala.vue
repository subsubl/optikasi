      ...
      <div class="container mx-auto px-6 max-w-4xl">
        <div class="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p class="text-gray-600 leading-relaxed mb-6">
              Naša specialnost je prevzem zahtevnih receptov in njihova pretvorba v udobna, 
              nosljiva stekla z brezhibno jasnostjo. Stranke, ki so jih drugje zavrnili, 
              pogosto pridejo k nam — in odidejo z očali, ki končno delujejo.
            </p>
            <ul class="space-y-3 text-gray-600">
              <li class="flex items-center space-x-3">
                <span class="text-accent">✓</span>
                <span>Visoka dioptrija (nad +/- 6)</span>
              </li>
              <li class="flex items-center space-x-3">
                <span class="text-accent">✓</span>
                <span>Progresivna in multifokalna stekla</span>
              </li>
              <li class="flex items-center space-x-3">
                <span class="text-accent">✓</span>
                <span>Korekcija astigmatizma</span>
              </li>
              <li class="flex items-center space-x-3">
                <span class="text-accent">✓</span>
                <span>Prizmatična stekla</span>
              </li>
            </ul>
          </div>
      ...
      <div class="container mx-auto px-6 max-w-5xl">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="bg-white p-8 border border-gray-100 text-center">
            <span class="text-4xl block mb-4">👩</span>
            <h3 class="font-serif text-xl text-primary-dark mb-3">Ženska Očala</h3>
            <p class="text-gray-600 text-sm leading-relaxed">
              Eleganca in udobje. Okvirji, ki poudarijo stil in hkrati ustrezajo 
              vsakodnevni uporabi.
            </p>
          </div>
          ...
          <div class="bg-white p-8 border border-gray-100 text-center">
            <span class="text-4xl block mb-4">👨</span>
            <h3 class="font-serif text-xl text-primary-dark mb-3">Moška Očala</h3>
            <p class="text-gray-600 text-sm leading-relaxed">
              Klasični, sodobni in profesionalni videzi. Vzdržljivost z rafiniranim 
              dizajnom.
            </p>
          </div>
          ...
          <div class="bg-white p-8 border border-gray-100 text-center">
            <span class="text-4xl block mb-4">👶</span>
            <h3 class="font-serif text-xl text-primary-dark mb-3">Otroška Očala</h3>
            <p class="text-gray-600 text-sm leading-relaxed">
              Udobna, vzdržljiva in zabavna. Oblikovana za aktivne otroke pri učenju, 
              igri in športu.
            </p>
          </div>
    ...
    <section class="py-24">
      <div class="container mx-auto px-6 max-w-4xl">
        ...
        <p class="text-gray-600 leading-relaxed text-center max-w-3xl mx-auto mb-12">
          ...
          znamk, skrbno izbrane za kakovostne materiale in brezčasen videz.
        </p>
        <div class="grid md:grid-cols-4 gap-6 text-center">
          ...
          <div class="p-6 border border-gray-100">
            <h4 class="font-medium text-primary-dark mb-2">Kovinski</h4>
            <p class="text-gray-500 text-xs">Klasični in profesionalni</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-24 bg-cream">
      <div class="container mx-auto px-6 max-w-4xl">
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <div class="bg-white p-8 border border-gray-100">
            <h3 class="font-serif text-xl text-primary-dark mb-4">Računalniška</h3>
            <p class="text-gray-600 text-sm leading-relaxed">
              Optimizirana za delo na računalniku. Zmanjšujejo utrujenost oči in filtrirajo 
              modro svetlobo.
            </p>
          </div>
