<template>
  <div class="flex flex-col min-h-screen bg-cream font-sans">
    <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-6 focus:py-3 focus:bg-primary-dark focus:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-accent font-bold uppercase tracking-widest text-xs shadow-lg transition-transform duration-300">
    ...
    <footer class="bg-primary-dark text-white py-12">
      <div class="container mx-auto px-6 text-center">
        ...
        <!-- Social Links -->
        <a href="https://www.instagram.com/optikasi/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="Sledite nam na Instagramu" class="inline-block text-white hover:text-accent focus-visible:ring-2 focus-visible:ring-accent focus:outline-none transition-colors mb-6 rounded-sm px-2 py-1">
