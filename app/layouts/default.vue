<template>
  <div class="flex flex-col min-h-screen bg-cream font-sans">
    <a href="#main-content" class="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 z-[100] bg-primary-dark text-white px-6 py-3 font-bold uppercase tracking-widest text-sm shadow-lg focus:outline-none focus:ring-2 focus:ring-accent transition-all">
      Preskoči na vsebino
    </a>
