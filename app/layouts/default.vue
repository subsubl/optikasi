  ...
  <div class="flex flex-col min-h-screen bg-cream font-sans">
    ...
    <footer class="bg-primary-dark text-white py-12">
      <div class="container mx-auto px-6 text-center">
        ...
        <!-- Social Links -->
        <a href="https://www.instagram.com/optikasi/?hl=en" target="_blank" rel="noopener noreferrer" aria-label="Sledite nam na Instagramu" class="inline-block text-white hover:text-accent transition-colors mb-6 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-primary-dark">
