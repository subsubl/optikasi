<template>
  <div class="flex flex-col min-h-screen bg-cream font-sans">
    <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:p-4 focus:bg-white focus:text-primary-dark focus:font-bold focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-dark">
