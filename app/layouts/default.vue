<template>
  <div class="flex flex-col min-h-screen bg-cream font-sans">
    <a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-primary focus:text-white focus:font-bold focus:rounded focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2">
